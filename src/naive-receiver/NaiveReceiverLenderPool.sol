...
contract NaiveReceiverLenderPool is ReentrancyGuard, IERC3156FlashLender {
    ...
    //@audit-info returns the amount of flashLoan one can take
    ...
    function flashLoan(
        ...
        //@audit-info reverts if the tx doesnt return the amount borrowed
